...
func (c *CiliumEBPFRuntime) LoadBpfObjects(opts *ebpf.CollectionOptions) error {
	...
	// map Pinning or make this Area Clean.
	spec.Maps["Map_name"].Pinning = ebpf.PinByName
...
func (c *CiliumEBPFRuntime) CreateCiliumEBPFRuntime(isAlreadyPinned bool) error {
	...
	/*
		// The Alternative of LoadBpfObjects()
		err := generate.LoadBpfObjects(&ebpf.CollectionOptions{
			Maps: ebpf.MapOptions{
				PinPath: FS,
			},
		})
